...
<template>
  <article v-if="post" class="max-w-7xl mx-auto">
    ...
    <header class="mb-16 text-center">
      <h1 class="text-4xl md:text-6xl font-extrabold tracking-tight text-slate-900 mb-8 leading-tight">
        {{ post.title }}
      </h1>
    ...
    <div class="mt-20 text-center">
      <NuxtLink to="/"
        ...
        <Icon name="lucide:arrow-left" class="group-hover:-translate-x-1 transition-transform" />
        トップへ戻る
      </NuxtLink>
    </div>
  </article>
