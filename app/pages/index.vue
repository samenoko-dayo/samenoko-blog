...
<template>
  <div class="space-y-12">
    <section
      ...
      <div class="absolute top-0 right-0 -translate-y-1/2 translate-x-1/2 w-64 h-64 bg-slate-50 rounded-full blur-3xl">
      </div>

      <div class="relative z-10 px-6">
        <h1 class="text-5xl md:text-7xl font-extrabold tracking-tight text-slate-950 mb-8">
    ...
    <section>
      <div class="flex items-center justify-between mb-10">
        <h2 class="text-2xl font-bold tracking-tight text-slate-900 flex items-center gap-4">
